...
const INSTRUCTIONS = [
  ...
  'Repeat with different fan designs and distances: 15cm, 30cm, and 45cm.',
  'Repeat with cardboard instead of paper.',
];

export default function HandFanIntroScreen() {
  const { theme } = useAppTheme();

  function handleStart() {
    router.push('/activity/hand-fan-setup');
  }
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: theme.colors.background }]}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text variant="bodyLarge" style={styles.description}>
          Test how air movement affects flexible materials by measuring how much paper or cardboard bends.
        </Text>
        ...
        <Text variant="bodyMedium" style={[styles.tip, { backgroundColor: theme.colors.surfaceVariant }]}>
          Tip: Keep the fan distance consistent and record the bend angle carefully for each trial.
        </Text>
